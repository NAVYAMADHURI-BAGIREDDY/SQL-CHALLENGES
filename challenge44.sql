...
INSERT INTO house_price44(id, state, city, street_address, mkt_price) VALUES
...
*/
select * from house_price44;
select h1.* from house_price44 h1
where h1.mkt_price >
(select avg(mkt_price) as avg_price from house_price44 h2
...
SELECT 
    ...
    h1.city,
    h1.mkt_price
FROM house_price44 h1 
WHERE  h1.mkt_price > (SELECT 
                        AVG(h2.mkt_price) 
                    FROM house_price44 h2
