...
INSERT INTO user_flags32(user_firstname, user_lastname, video_id, flag_id) VALUES
...
*/
select * from user_flags32
where video_id = 'dQw4w9WgXcQ';
select count(distinct(concat(user_firstname,user_lastname))) as uniqe,video_id from user_flags32
