...
INSERT INTO hotel_bookings18(booking_date, hotel_name, total_guests, total_nights, total_price) VALUES
...
select * from hotel_bookings18;
 select * from
(select extract(month from hotel_bookings18.booking_date) as month ,
 extract(year from hotel_bookings18.booking_date) as year ,
hotel_name,total_price,dense_rank() over(partition by hotel_name order by total_price desc) as rnk
from hotel_bookings18) as sub
where rnk<2;
