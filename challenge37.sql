...
CREATE TABLE spending_records37(
...
INSERT INTO spending_records37(record_id, customer_id, spending_amount, spending_date) VALUES
...
select c.customer_name,s.customer_id,
sum(spending_amount) as mnth_spent,
extract(month from spending_date) as mnth
from customers37  c
left join spending_records37 s
on c.customer_id = s.customer_id
group by customer_name,customer_id,mnth;
