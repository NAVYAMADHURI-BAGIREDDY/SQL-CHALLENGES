...
*/
select * from forbes_global44;
with rnking as (select *,Dense_rank() over(partition by country order by profits) as rnk
from forbes_global44 ) 
select * from rnking
where rnk =1;
