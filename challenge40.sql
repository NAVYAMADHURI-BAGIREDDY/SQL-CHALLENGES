...
-- Add records
-- Add records
INSERT INTO order_data40(order_time, customer_id, total_amount) VALUES
...
*/
select extract(hour from order_time) as hrs,count(*) as total_orders,
count(*) / (select count(*) from order_data40)* 100 as percent_orders
from order_data40
group by hrs
order by hrs asc;
